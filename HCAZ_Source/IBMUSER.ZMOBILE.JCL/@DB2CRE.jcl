//HCZMDB2 JOB 241901,'DB2 create',NOTIFY=&SYSUID,CLASS=A,MSGCLASS=H
//*
...
//*
//JOBLIB   DD DSN=DB2.V10.SDSNLOAD,DISP=SHR
//*
//********************************************************************
...
//SYSTSIN  DD *
   ...
   RUN  PROGRAM(DSNTIAD) PLAN(DSNTIA10) -
        LIB('DB2.V10.DB1S.RUNLIB.LOAD')
//SYSPRINT DD SYSOUT=*
//SYSUDUMP DD SYSOUT=*
//SYSIN    DD *
  SET CURRENT SQLID='DDS1491' ;
  CREATE   STOGROUP HCZMSG02 VOLUMES ('*') VCAT DBAWK1;
