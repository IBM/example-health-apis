      ...
      *----------------------------------------------------------------*
      * start of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\HCERRSWS.cpy at HCIPDB01.cbl line 44
      * Error handler
      ...
      * end of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\HCERRSWS.cpy at HCIPDB01.cbl line 44
      *----------------------------------------------------------------*
      ...
      * start of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\SQLCA.cpy at HCIPDB01.cbl line 70
       01  SQLCA.                                                       00010000
      ...
      * end of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\SQLCA.cpy at HCIPDB01.cbl line 70
      *
      *
      ******************************************************************
      ...
      ******************************************************************
       ...
       01  DFHCOMMAREA.
      * start of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\HCCMAREA.cpy at HCIPDB01.cbl line 81
      ******************************************************************
      *                                                                *
      * LICENSED MATERIALS - PROPERTY OF IBM                           *
      *                                                                *
      ...
      * end of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\HCCMAREA.cpy at HCIPDB01.cbl line 81
      ...
      *----------------------------------------------------------------*
       ...
       GET-PATIENT-INFO.
           ...
           EXIT.
      *----------------------------------------------------------------*
      * start of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\HCERRSPD.cpy at HCIPDB01.cbl line 195
      *================================================================*
      ...
      * Write 90 bytes or as much as we have of commarea to TDQ
           ...
           END-IF.
           EXIT.
      * end of expanded file: C:\REGI_EZSOURCE\IBMUSER.ZMOBILE.COPYLIB\HCERRSPD.cpy at HCIPDB01.cbl line 195
